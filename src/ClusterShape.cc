...
vector<double> Unfold(const vector<double>& q, double x0, double x1, double x2){
 ...
 for(unsigned int i=0;i<q.size();i++) out[i] = vOut(i);
...
vector<double> ClusterizationWithNoise(vector<double> UnderCluster, double QStrip, double RelDiffQStrip){
    ...
    if(UnderCluster.size()<4){
        ...
        for(unsigned int i=0;i<UnderCluster.size();i++){
...
//    string filename = "/eos/cms/store/group/dpg_tracker_strip/comm_tracker/Strip/Calibration/calibrationtree/GR17_Aag/calibTree_304777_25.root";
    ...
    // TTree* tree = (TTree*) ifile->Get("eventInfo/tree");

    // vector <string> filenames;
    // list_dir(path, &filenames);
...
//------------------------------------
    ...
    c4->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/testClusters.pdf");
    c4->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/testClusters.png");
    ...
    for(unsigned int c=0;c<clusterWidth->size();c++){
        ...
        if(clusterOverlapping->at(c)==0 && clusterFarfromedge->at(c)==1 && clusterSaturation->at(c)==0){
            ...
            /*if(ObsCW ==8 && ExpCW <= 2 && RecSelCW <= 2){
                ...
                for(unsigned int i=0;i<q.size()+2;i++) ligneThreshold->Fill(i,13.);
                pUnfoldCluster->Reset();
                for(unsigned int i=0;i<QUnfold.size();i++){
                ...
                for(unsigned int i=0;i<UnderCluster.size()+2;i++) ligneQStrip->Fill(i,qstripfromtreatment);
                for(unsigned int i=0;i<ClusterSel.size();i++){
                ...
                legend->Draw("SAME");
                c4->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/cluster1.pdf");
                c4->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/cluster1.png");
                c4->cd(2);
                ...
                pClusterSel->Draw();
                c4->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/cluster.pdf");
                c4->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/cluster.png");
                getchar();
                pObsCluster->Reset();
                pUnfoldCluster->Reset();
                pUnderCluster->Reset();
    ...
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ExpVsRec.pdf");
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ExpVsRec.png");
    ...
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ExpVsObs.pdf");
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ExpVsObs.png");
    ...
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ExpVsRecSel.pdf");
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ExpVsRecSel.png");
    ...
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ExpVsUnfold.pdf");
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ExpVsUnfold.png");
    ...
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ExpVsWeight.pdf");
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ExpVsWeight.png");

    hRelDiffCrossTalkWeighted->GetXaxis()->SetTitle("(Weighted - Normal)/Normal CrossTalk Cluster Width");
    c2->cd();
    gStyle->SetOptStat(0);
    hRelDiffCrossTalkWeighted->Draw();
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/RelDiffWeighted.pdf");
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/RelDiffWeighted.png");
...
//--------- //ClusterWidth
    ...
    c1->Write();
    gStyle->SetOptStat(0);
    c1->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ClusterWidth.pdf");
    c1->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/ClusterWidth.png");
...
//--------- //RelDiffCWTopo
    ...
    leg2->Draw("SAME");
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/RelDiff.pdf");
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/RelDiff.png");
    c2->Write();
    c2->cd();
    ...
    leg2->Draw("SAME");
    c2->Write();
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/RelDiff2.pdf");
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/RelDiff2.png");
...
//--------- //RelDiffCrossTalk
    ...
    leg3->Draw("SAME");
    c2->Write();
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/RelDiffCrossTalk.pdf");
    c2->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/RelDiffCrossTalk.png");
...
//--------- //Charge
    ...
    leg4->Draw("SAME");
    c3->Write();
    c3->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/Charge.pdf");
    c3->SaveAs("/afs/hephy.at/user/l/llechner/www/ClusterSplitting/MCbased/Charge.png");
//---------
